...
getBinDir = catchIO (getEnv "haskell_neo4j_bindir") (\_ -> return bindir)
getLibDir = catchIO (getEnv "haskell_neo4j_libdir") (\_ -> return libdir)
getDataDir = catchIO (getEnv "haskell_neo4j_datadir") (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "haskell_neo4j_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "haskell_neo4j_sysconfdir") (\_ -> return sysconfdir)
